...
## Differences
Cholesterol and ergosterol have similar shapes, but the Hax(7) which is pointing out of the plane of cholesterol is not present in ergosterol because it has a sp<sub>2</sub> hybridisation. This hydrogen atom can be <a href='javascript:jmolScript("select atomno = 41;color [0,255,0]", "A")'>highligheted</a> in green in the structures of Table 1. The <a href='javascript:jmolScript("select atomno = 30;select atomno = 48;select atomno = 62;color [0,127,127]", "A")'>other three additional</a> H of cholesterol are probably not as important. Note the additional methyl of ergosterol at the end of the side chain.
