...
Here sync:<code><a href='javascript:Jmol.script(JmolAppletA,"sync")'>on</a></code>/'>on</a></code> 
Here sync:<code><a href='javascript:Jmol.script(JmolAppletA,"sync on")'>on</a></code>/'>on</a></code> 
Here sync:<code><a href='javascript:Jmol.script(JmolAppletA,"sync off")'>on</a></code>/'>on</a></code> 
